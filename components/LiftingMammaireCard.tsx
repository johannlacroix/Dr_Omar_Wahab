...
export function LiftingMammaireCard({ image, imagePosition = 'left' }: LiftingMammaireCardProps) {
  ...
  return (
    <>
      ...
      <AccessibleModal
        ...
        closeLabel="Fermer la fenêtre d'information sur le lifting mammaire"
      >
